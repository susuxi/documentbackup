...
public class operateController<T, S> implements ControlledStage, Initializable {
	...
	public void synStrategy() throws IOException{
		...
		case "每天一次":   timingSyn(86400000);break;
		case "每12小时":    timingSyn(43200000);break;
		case "每6小时": timingSyn(21600000);break;
		case "每2小时": timingSyn(7200000);break;
		case "每1小时": timingSyn(3600000);break;
